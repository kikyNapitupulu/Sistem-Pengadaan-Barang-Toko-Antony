    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2 mb-4 mb-md-0">
                ...
                <a href="<?= base_url('profile/setting'); ?>" class="btn btn-sm btn-block btn-primary"> Edit Profile</a>
                <a href="<?= base_url('profile/ubahpassword'); ?>" class="btn btn-sm btn-block btn-primary"> Ubah Password</a>
            </div>
            <div class="col-md-10">
                <table class="table">
                    <tr>
