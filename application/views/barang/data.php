                    ...
                    foreach ($barang as $b) :
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Yakin ingin menghapus data?')" href="<?= base_url('barang/delete/') . $b['id_barang'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
